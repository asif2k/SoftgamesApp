...
class SimpleParticleSystem extends PIXI.Sprite {
    ...
    // all textures for partical that are used based upon partical life , 0-n , last texture is used for small life
    public particleTextures: PIXI.Texture[] = []

    //sprite pool that store sprites and reused sprites when partical life ends
    public spritePool: ObjectsPool;
    public clock: number = 0;

    //partical texture sheets and size information to generate small texture frames
    //also set maximum number sprites allowed 
